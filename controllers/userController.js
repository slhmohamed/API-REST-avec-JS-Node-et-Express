...
exports.deleteUser = asyncHandler(async (req, res) => {
  ...
  return new SuccessMsgDataResponse(deletedUser, "User deleted successfully").send(res);
});
exports.createUser = asyncHandler(async (req, res) => {
  ...
  return new SuccessMsgDataResponse(data, "User created successfully").send(res);
});
